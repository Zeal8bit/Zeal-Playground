...
async function readFile(path) {
  ...
  return await explorer.readFile(name, path);
}

async function assemble() {
  const editor = document.getElementById('editor').editor;
  editor.eachLine((lineHandle) => {
    editor.removeLineClass(lineHandle, "background");
    editor.removeLineClass(lineHandle, "text");
    editor.removeLineClass(lineHandle, "wrap");
  });
  ...
  try {
    ...
    if (error.s) {
      ...
      editor.addLineClass(error.s.numline, "background", "error-line");
    } else {
